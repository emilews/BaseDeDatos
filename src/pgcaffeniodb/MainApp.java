...
public class MainApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bTeam_Plays = new javax.swing.JMenuItem();
        ...
        bTeam_Plays.setText("Team Plays");
        bTeam_Plays.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bTeam_PlaysActionPerformed(evt);
            }
        });
        menuBrowse.add(bTeam_Plays);
...
//                + "total AS Total FROM coffees ORDER BY cof_name";
    ...
    private void bTeam_PlaysActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bTeam_PlaysActionPerformed
        final String sql = "SELECT * FROM team_plays ORDER BY game_code";
        final String labels[] = {"Team", "Game"};
        try {
            ResultSet rs = db.query(sql);

            JDBCTableAdpater modelo = new JDBCTableAdpater(rs, labels);
            TableBrowser browser = new TableBrowser("Team Plays", modelo);
            browser.setVisible(true);
            this.desktopPane.add(browser);

        } catch (SQLException ex) {

        }        }//GEN-LAST:event_bTeam_PlaysActionPerformed
    ...
    private javax.swing.JMenuItem bTeam_Plays;
